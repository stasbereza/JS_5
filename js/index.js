...
console.log('the array of user\'s posts with new post: ', socialBook.addPost('-s19a6hqce', { id: getId(), text: "post #4", likes: 0 }));
console.log('the array of user\'s posts with new post: ', socialBook.addPost('-qkpzenjxe', { id: getId(), text: "post #3", likes: 0 }));
console.log('the array of user\'s posts with new post: ', socialBook.addPost('-e51cpd4di', { id: getId(), text: "post #3", likes: 0 }));
